> **Frozen snapshot.** This is not the live SpaceY app. The current gym is TypeScript at the repo root — see [`../../README.md`](../../README.md) and [`../../docs/legacy.md`](../../docs/legacy.md). Do not expect this tree to build.
